...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `Start : Find	<< &ast.Search{Find: X[0].(*ast.Find)} , nil >>`,
		Id:         "Start",
		NTType:     1,
		Index:      1,
		NumSymbols: 1,
		ReduceFunc: func(X []Attrib) (Attrib, error) {
			return &ast.Search{Find: X[0].(*ast.Find)} , nil
		},
	},
	ProdTabEntry{
	...
	ProdTabEntry{
		String: `Find : "find" AuthorKeyWord Space "with" Space id TimeRange Space "at" Space TimeRange	<< ast.NewFind(X[1].(*ast.FindType), X[5].(*ast.Criteria), X[9].(*ast.DateTimeInterval)) , nil >>`,
		Id:         "Find",
		NTType:     2,
		Index:      3,
		NumSymbols: 11,
		ReduceFunc: func(X []Attrib) (Attrib, error) {
			return ast.NewFind(X[1].(*ast.FindType), X[5].(*ast.Criteria), X[9].(*ast.DateTimeInterval)) , nil
		},
	},
	ProdTabEntry{
		String: `Find : "find" TitleKeyWord Space "with" Space id Space "at" Space TimeRange	<< ast.NewFind(X[1].(*ast.FindType), X[5].(*ast.Criteria), X[9].(*ast.DateTimeInterval)) , nil >>`,
		Id:         "Find",
		NTType:     2,
		Index:      4,
		NumSymbols: 10,
	...
	ProdTabEntry{
		String: `DateTimeInterval : DateTime "--" DateTime	<< ast.Interval(ast.NewDateTime(X[0].(*ast.DateTime)), ast.NewDateTime(X[2].(*ast.DateTime))), nil >>`,
		Id:         "DateTimeInterval",
		NTType:     8,
		Index:      14,
		NumSymbols: 3,
		ReduceFunc: func(X []Attrib) (Attrib, error) {
			return ast.Interval(ast.NewDateTime(X[0].(*ast.DateTime)), ast.NewDateTime(X[2].(*ast.DateTime))), nil
		},
	},
	ProdTabEntry{
